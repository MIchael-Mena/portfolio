...
import {SkillData, IconData} from "../SkillData";
...
export class ModalSkillComponent {
  ...
  // public invalidFormatError: boolean = true;
  ...
  constructor(public dialogRef: MatDialogRef<ModalSkillComponent>,
    ...
    if (skill) {
      ...
      this.previewFileUrl = skill.icon.content;
  ...
  public setSvgFile(svg: IconData): void {
    this.svg = svg;
  }
  ...
  public onSubmit(): void {
    if (this.form.invalid || this.svg === null) {
      if (this.svg === null) this.iconHasRequiredError = true;
      return;
    }
  ...
  public deleteIcon(): void {
    ...
    this.iconHasRequiredError = false;
  }
