...
import { EditField } from './models/EditField';
import { StorageSessionService } from 'src/app/core/services/storage-session.service';
...
export class AboutComponent implements OnInit {
  ...
  public aboutMe: AboutMeData = <AboutMeData>{
    photo: '/assets/icon/png/profile-preview-alt.jpg',
  };
