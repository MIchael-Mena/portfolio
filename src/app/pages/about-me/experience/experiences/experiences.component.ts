...
import { ExperienceData } from 'src/app/pages/about-me/models/ExperienceData';
...
export class ExperiencesComponent implements OnInit {
  ...
  public showForm(): void {
    this.formExperienceConfig = {
      ...this.formExperienceConfig,
      showForm: !this.formExperienceConfig.showForm,
    };
  }
  ...
  public deleteExperience(experience: ExperienceData): void {
    this.experiences = this.experiences.filter(
      (t: ExperienceData) => t.id !== experience.id
    );
  }
